...
import { continueWith } from '../utils/continue-with.js';
...
const getTxSuccessFromSystemEvents = (systemEvents, txIdx) => {
  const events = systemEvents.filter((x) => x.phase.type === "ApplyExtrinsic" && x.phase.value === txIdx).map((x) => ({ ...x, ...x.event }));
...
//# sourceMappingURL=submit-fns.js.map
