...
import { unifyMetadata, metadata, Enum } from '@polkadot-api/substrate-bindings';
import { fromHex, mergeUint8 } from '@polkadot-api/utils';
import { getSignExtensionsCreator } from './tx/signed-extensions/sign-extensions.js';
...
const createOfflineTxEntry = (pallet, name, metadataRaw, dynamicBuilder, signExtensionCreator) => {
  ...
  return (arg) => {
    ...
    return {
      ...
      sign: async (from, extensions) => await from.signTx(
        encodedData,
