...
import { selfDependent } from './utils/self-dependent.js';
        ...
        return storage(
          ...
          mergeMap((merkleValueResult) => {
            ...
            return storage(
              ...
              map(
                ([entriesResult, runtimeCtx]) => [entriesResult.value, getPatcher(runtimeCtx)]
              ),
              map(([entries, patcher]) => ({
...
//# sourceMappingURL=watch-entries.js.map
