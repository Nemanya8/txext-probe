...
declare function renderFailure(reason: string): RenderFailure;
/**
 ...
 */
declare function registerRenderContext(client: TrUApiClient, tag: RenderContextTag, handler: RenderHandler): RenderRegistration;
 ...
 * ```
 */
declare function getRendererManager(): Promise<RendererManager | null>;
...
interface PocketManager {
    ...
    subscribeCardAction(cardId: string, callback: (action: PocketCardAction) => void): HostSubscription;
 ...
 * ```
 */
declare function getPocketManager(): Promise<PocketManager | null>;
...
export { type AccountsProvider, BULLETIN_RPCS, type CardCleanup, type CardDrawHandler, type CardDrawRegistration, ChainNotSupportedError, type ChainProperties, type ChainSpec, type ChatBotRegistrationResult, type ChatManager, type ChatReceivedAction, type ChatRoomRegistrationResult, type ContextualAlias, DEFAULT_BULLETIN_ENDPOINT, type DevicePermissionKind, type Feature, type HostAccount, HostCallFailedError, HostError, type HostErrorPayload, type HostLocalStorage, HostResponseDecodeError, type HostStatementStore, type HostSubscription, HostUnavailableError, type LocaleInfo, type LocaleProvider, type NotificationManager, type PaymentManager, type PocketCardAction, type PocketManager, type PreimageManager, type ProductAccount, type ProductAccountLookup, type PushNotificationInput, type RegisteredRingVrfKey, type RemotePermissionItem, type RenderCleanup, type RenderContextTag, type RenderFailure, type RenderHandler, type RenderRegistration, type RendererManager, type ResultAsync, type RingVRFProof, type RingVrfKeyHandle, type RingVrfPublicKey, type StatementTopicFilter, type StatementsPage, type ThemeMode, type ThemeProvider, type TruApi, type VrfSignature, type VrfTranscriptItem, type WithDecodeError, broadcastTransaction, createHostLocalStorage, createHostPreimageManager, createProofAuthorized, deriveEntropy, featureSupported, findRingVrfKeyHandle, formatHostError, fromHex, getAccountsProvider, getChainSpec, getChatManager, getHostLocalStorage, getHostProvider, getLocaleProvider, getNotificationManager, getPaymentManager, getPocketManager, getPreimageManager, getRendererManager, getStatementStore, getThemeProvider, getTruApi, isChainSupported, isHostError, isInsideContainer, navigateTo, registerRenderContext, renderFailure, requestDevicePermission, requestPermission, requestResourceAllocation, stopTransaction, toHex };
