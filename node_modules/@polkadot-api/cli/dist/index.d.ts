...
import { UnifiedMetadata, HexString } from '@polkadot-api/substrate-bindings';
...
declare function getMetadata({ metadata: metadataFile, codeHash, genesis, ...entry }: EntryConfig): Promise<{
