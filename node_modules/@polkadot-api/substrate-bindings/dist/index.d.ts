...
type SizedHex<T extends number> = string & {
...
declare const Binary: {
    ...
    toHex: (bytes: Uint8Array) => HexString;
    toOpaque: (bytes: Uint8Array) => Uint8Array<ArrayBufferLike>;
    fromText: (text: string) => Uint8Array<ArrayBuffer>;
    fromHex: (hex: HexString) => Uint8Array<ArrayBufferLike>;
    fromOpaque: (opaque: Uint8Array | HexString) => Uint8Array<ArrayBufferLike>;
};
declare const SizedBytes: (size: number) => scale_ts.Codec<string>;
...
type UnifiedMetadata<T extends 14 | 15 | 16 = 14 | 15 | 16> = {
    ...
    extrinsic: {
        ...
        extensionsByVersion: Record<number, Array<{
            identifier: string;
            type: number;
            additionalSigned: number;
        }>>;
...
export { AccountId, Binary, BitSeq, Blake2128, Blake2128Concat, Blake2256, Blake3256, Blake3256Concat, Enum, Hex, Identity, Keccak256, Option, Result, ScaleEnum, Self, SizedBytes, Storage, Struct, TrieNodeHeaders, TrieNodeWithHash, Tuple, Twox128, Twox256, Twox64Concat, Variant, Vector, _Enum, bitSequence, blockHeader, char, compactBn, compactNumber, decAnyMetadata, ethAccount, extrinsicFormat, fixedStr, fromBufferToBase58, getMultisigAccountId, getSs58AddressInfo, h64, metadata, selfDecoder, selfEncoder, sortMultisigSignatories, trieNodeDec, unifyMetadata, v14, lookup as v14Lookup, v15, v16, validateProofs };
export type { BitSequence, BlockHeader, EncoderWithHash, EnumVariant, ExtractEnumValue, ExtrinsicFormat, GetEnum, HexString, Metadata, Nibble, OpaqueKeyHash, ProofTrieNode, SS58AddressInfo, SS58String, SizedHex, TrieNode, TrieNodeHeaderKey, UnifiedMetadata, V14, V14Lookup, V15, V16 };
