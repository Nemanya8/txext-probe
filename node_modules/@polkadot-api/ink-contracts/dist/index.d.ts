...
import { CodecType, Codec, StringRecord, HexString } from '@polkadot-api/substrate-bindings';
...
declare const pjsTypes: Codec<{
    ...
    type: {
        def: PjsVariant<{
            composite: [_polkadot_api_substrate_bindings.Encoder<{
                fields: {
            ...
            variant: [_polkadot_api_substrate_bindings.Encoder<{
                variants: {
                    name: string;
                    fields: {
                        name: string | undefined;
            ...
            sequence: [_polkadot_api_substrate_bindings.Encoder<{
                type: number;
            }>, _polkadot_api_substrate_bindings.Decoder<{
                type: number;
            }>] & {
            ...
            array: [_polkadot_api_substrate_bindings.Encoder<{
                len: number;
                type: number;
            }>, _polkadot_api_substrate_bindings.Decoder<{
                len: number;
            ...
            tuple: [_polkadot_api_substrate_bindings.Encoder<number[]>, _polkadot_api_substrate_bindings.Decoder<number[]>] & {
                enc: _polkadot_api_substrate_bindings.Encoder<number[]>;
                dec: _polkadot_api_substrate_bindings.Decoder<number[]>;
            } & {
                inner: Codec<number>;
            };
            ...
            compact: [_polkadot_api_substrate_bindings.Encoder<{
                type: number;
            }>, _polkadot_api_substrate_bindings.Decoder<{
                type: number;
            }>] & {
            ...
            bitSequence: [_polkadot_api_substrate_bindings.Encoder<{
                bitStoreType: number;
                bitOrderType: number;
            }>, _polkadot_api_substrate_bindings.Decoder<{
                bitStoreType: number;
                ...
                inner: {
                    bitStoreType: Codec<number>;
                    bitOrderType: Codec<number>;
                };
            };
        }>;
        path: string[];
...
declare const getInkDynamicBuilder: (metadataLookup: InkMetadataLookup) => {
    ...
    buildEvents: () => [_polkadot_api_substrate_bindings.Encoder<{
        type: string;
        value: any;
    }>, _polkadot_api_substrate_bindings.Decoder<{
        type: string;
...
type InkCallableInterface<T extends InkCallableDescriptor> = <L extends string & keyof T>(label: L) => {
    encode: {} extends T[L]["message"] ? (value?: T[L]["message"]) => Uint8Array : (value: T[L]["message"]) => Uint8Array;
    decode: (value: {
        data: Uint8Array;
    }) => T[L]["response"];
    attributes: {
...
type InkStorageInterface<S extends InkStorageDescriptor> = ("" extends keyof S ? () => {
    encode: S[""]["key"] extends undefined ? (key?: undefined) => Uint8Array : (key: S[""]["key"]) => Uint8Array;
    decode: (data: Uint8Array) => S[""]["value"];
} : unknown) & (<L extends string & keyof S>(label: L) => {
    encode: S[L]["key"] extends undefined ? (key?: undefined) => Uint8Array : (key: S[L]["key"]) => Uint8Array;
...
type HasDefault<T> = "default" extends keyof T ? T["default"] extends true ? true : false : false;
...
export { getInkClient, getInkDynamicBuilder, getInkLookup };
export type { ArrayLayout, ConstructorSpec, EnumLayout, Event, EventParamSpec, EventSpecV5, FieldLayout, GenericEvent, HashLayout, InkCallableDescriptor, InkCallableInterface, InkClient, InkContractInfo, InkDescriptors, InkDynamicBuilder, InkEventInterface, InkMetadata, InkMetadataLookup, InkSource, InkStorageDescriptor, InkStorageInterface, Layout, LeafLayout, MessageParamSpec, MessageSpec, RootLayout, StorageEntryPoint, StorageLayout, StructLayout, TypeSpec };
