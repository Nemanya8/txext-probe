...
declare const generateDescriptors: (originalMetadata: UnifiedMetadata, lookupFn: MetadataLookup, checksumToIdx: Map<string, number>, typesBuilder: ReturnType<typeof getTypesBuilder>, checksumBuilder: ReturnType<typeof getChecksumBuilder>, key: string, paths: {
    client: string;
