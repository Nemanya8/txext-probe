import { AccountId, Struct, createDecoder, compactNumber, extrinsicFormat, u8, Bytes, enhanceDecoder, u16 } from '@polkadot-api/substrate-bindings';
import { getLookupFn, getDynamicBuilder } from '@polkadot-api/metadata-builders';
import { getMappedMetadata } from './mapped-metadata.js';
...
const getExtrinsicDecoder = (metadata, dynamicBuilder) => {
  ...
  return createDecoder((data) => {
    ...
    if (metadata.version === 16) {
      const extensionsToApply = metadata.extrinsic.signedExtensions[extensionVersion];
...
//# sourceMappingURL=create-metadata-ctx.js.map
