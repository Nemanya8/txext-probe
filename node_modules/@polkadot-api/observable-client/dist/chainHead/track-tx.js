import { Observable, map, distinctUntilChanged, merge, take, mergeMap, of, distinct, startWith, finalize, takeUntil, filter } from 'rxjs';
...
const u8eq = (a, b) => a.length === b.length && a.every((v, i) => b[i] === v);
